	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand() == "Open") {
			...
			if (returnVal == JFileChooser.APPROVE_OPTION) {
				...
				//The reader for each line for the file
				BufferedReader reader = null;
				//Needed so that if the file is not found, the program will not crash
				try {
					reader = new BufferedReader(new FileReader(file)); //Reads the lines in each line of the file
